...
/**
 * Iterable - интерфейс, который позволяет последовательно
 * проходиться по элементам коллекции
 *
 * Iterator - тоже интерфейс. Паттерн, который предоставляет
 * способ последовательного доступа к элементам коллекции
 * без раскрытия внутренней структуры
 *
 *

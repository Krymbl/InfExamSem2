...
/** Разница между Comarable и Comparator.
 *
 * Comparable - интерефейс, который определяет способ сравнивать объект с другими объектами одного типа
 * Comparator - интерфейс, который позволяет определить пользовательскую логику сравнения объектов
 */
